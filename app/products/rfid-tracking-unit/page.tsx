...
export const metadata = {
  ...
  openGraph: {
    title: prod?.title || 'RFID Tracking Unit',
    description: getMetaDescription(prod),
    url: `${SITE_URL}/products/rfid-tracking-unit`,
  },
  twitter: { card: 'summary_large_image', title: prod?.title || 'RFID Tracking Unit', description: getMetaDescription(prod) },
  alternates: { canonical: `${SITE_URL}/products/rfid-tracking-unit` },
}
