...
export const metadata = {
  ...
  openGraph: {
    title: prod?.title || 'FRS',
    description: getMetaDescription(prod),
    url: `${SITE_URL}/products/frs`,
  },
  twitter: { card: 'summary_large_image', title: prod?.title || 'FRS', description: getMetaDescription(prod) },
  alternates: { canonical: `${SITE_URL}/products/frs` },
}
