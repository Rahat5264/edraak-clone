...
export const metadata = {
  ...
  twitter: { card: 'summary_large_image', title: prod?.title || 'High-Speed Camera Module', description: getMetaDescription(prod) },
  alternates: { canonical: `${SITE_URL}/products/high-speed-camera-module` },
}
