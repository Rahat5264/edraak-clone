...
export const metadata = {
  ...
  twitter: { card: 'summary_large_image', title: prod?.title || 'Cutting Optimization Module', description: getMetaDescription(prod) },
  alternates: { canonical: `${SITE_URL}/products/cutting-optimization-module` },
}
