...
const prod = {
  ...
  summary: 'Linked with digital encoders, Ultra High Speed Scanners detect seam optically, also the Barcode in real-time. Giving you the most accurate fabric meters for',
  need: [
