          ...
          <div>
            ...
            <div className="socials-bar mt-6 h-12 max-w-xs bg-white text-[var(--site-header-bg)] flex items-center justify-between px-4 text-sm md:text-base font-medium">
              ...
              <div className="flex items-center gap-2">
                <a href="https://x.com/edraaksystems" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="h-7 w-7 flex items-center justify-center text-[var(--site-header-bg)]">
                  <Twitter className="h-4 w-4" />
                </a>
                <a href="https://www.linkedin.com/company/edraak-systems/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="h-7 w-7 flex items-center justify-center text-[var(--site-header-bg)]">
                  <Linkedin className="h-4 w-4" />
                </a>
                <a href="https://www.youtube.com/@IndustrialProcessOptimization" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="h-7 w-7 flex items-center justify-center text-[var(--site-header-bg)]">
